...
import { ArrowDownIcon, ArrowUpRightIcon, CheckBadgeIcon } from "@heroicons/react/24/solid";
		...
		<div>
			...
			>
                ...
                md:justify-between md:flex-row-reverse"
					>
						<div
							id={theme === "light" ? "introsvg_light" : "introsvg_dark"}
						...
						<div className="flex flex-col justify-center items-center">
							...
							<div className="text-3xl break-words p-4 text-center xl:text-4xl xl:w-4/6">
								An Aspiring <span className="text-accent">Data Scientist</span>, a
								Full Stack Developer, and a 4rd year Undergrad at MITWPU in Pune,
								interning at{" "}
								<a
									href="https://ideas.com/"
			...
			>
				...
				<div className="text-center text-2xl p-4 m-4 lg:text-3xl xl:w-3/6 ">
					I have worked on several Projects ever since I started coding. They span across
					fields like
				...
				<NavLink to={"/projects"} className="m-4 mt-10">
					<button className="btn btn-secondary btn-lg ">
						Visit My Projects <ArrowUpRightIcon className="w-5 h-5" />
					</button>
				</NavLink>
			</section>
			<div class="wrapper pb-9">
			...
			>
				...
				<div className="text-center text-2xl p-4 m-4 break-words lg:text-3xl lg:w-4/6">
					I am a 3rd Year Undergrad at MIT World Peace Univeristy in Pune, pursuing my
					Bachelors in Computer Science, Majoring in
					<span className="text-accent"> Cyber Security and Forensics.</span>
					<br></br>
					<br></br>I am a Full Stack Developer, and a Data Science Enthusiast. I've
					completed my education from{" "}
					<span className="text-accent"> Tanzania, Qatar and India.</span>
					Fortunately, Along the road, I've had the opportunity to learn a lot of
					interesting things, and meet a lot of interesting people!
					<br></br>
					<br></br>
					Visit my about page to know more about my background and perhaps a little more
					about me...
				</div>
			...
			>
				...
				<div className="text-center text-2xl p-4 m-4 lg:text-3xl xl:w-3/6 ">
					You can contact me via my Email, Phone or any social Media. I am always open to
					new opportunities and collaborations, and always happy to help.
