    ...
    <div>
          ...
          >
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <div className="text-3xl break-words p-4 text-center xl:text-4xl xl:w-4/6">
                An Aspiring <span className="text-accent">Data Scientist</span>,
                a Full Stack Developer, and a 3rd year Undergrad at MITWPU in
                Pune.
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div className="text-center text-2xl p-4 m-4 lg:text-3xl xl:w-3/6 ">
          I have worked on several Projects ever since I started coding. They
          span across fields like
      ...
      >
        ...
        <div className="text-center text-2xl p-4 m-4 break-words lg:text-3xl lg:w-4/6">
          I am a 3rd Year Undergrad at MIT World Peace Univeristy in Pune,
          pursuing my Bachelors in Computer Science, Majoring in
          <span className="text-accent"> Cyber Security and Forensics.</span>
          <br></br>
          <br></br>I am a Full Stack Developer, and a Data Science Enthusiast.
          I've completed my education from{" "}
          <span className="text-accent"> Tanzania, Qatar and India.</span>
          Fortunately, Along the road, I've had the opportunity to learn a lot
          of interesting things, and meet a lot of interesting people!
          <br></br>
          <br></br>
          Visit my about page to know more about my background and perhaps a
